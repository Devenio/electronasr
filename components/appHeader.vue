<template>
  <div class="w-full shadow-lg sticky top-0 bg-white z-20">
    <nav
    ...
    >
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <div class="text-main text-xs lg:text-sm">electronasr</div>
            <div class="text-main text-xs lg:text-sm">عامل فروش لوازم برقی</div>
          </div>
        </div>
